...
module.exports = class MonsterGame {
  ...
  // List monsters
  listMonsters = () => //Touch up later when function gives no syntax errors
    this.monsters.forEach(monst => console.log(`Monster: ${monst.monsterName}, Minimum Life: ${monst.minimumLife}, ` +
    `Current Life: ${monst.currentLife}, Status: ${(monst.currentLife >= monst.minimumLife ? `Alive` : `Dead`)}`));
